...
with PdfPages('data_visualization.pdf') as pdf:
        ...
        ax = pd.DataFrame(no_of_python_students).plot(kind='bar', figsize=(10,7), color='coral', fontsize=13);
        ax.set_alpha(0.8)
        ax.set_title("Interns who knew python and have applied for data science", fontsize=18)
        ...
        # Create bars and choose color
        ax = pd.DataFrame(no_of_BE_students).plot(kind='bar', figsize=(10,7), color='coral', fontsize=13)
        ax.set_alpha(0.8)
        ax.set_title("Classification of BE students", fontsize=18)
        ax.set_ylabel("Number of students", fontsize=18)
        ...
        for i in ax.patches:
            # get_x pulls left or right; get_height pushes up or down
            ax.text(i.get_x() + 0.18, i.get_height() + 10, str(i.get_height()), fontsize=13, color='dimgrey')
        ...
        bars = ["Above or Equal to 8", "Below 8"]

        # Create bars and choose color
        ax = pd.DataFrame(dm_students).plot(kind='bar', figsize=(10,7), color='#EB491E', fontsize=13);
        ax.set_alpha(0.8)
        ax.set_title("Classification of students based on Written and Verbal skills", fontsize=18)
        ax.set_ylabel("Number of students", fontsize=18)
        ...
        for i in ax.patches:
            # get_x pulls left or right; get_height pushes up or down
            ax.text(i.get_x() + 0.22, i.get_height() + 5, str(i.get_height()), fontsize=13, color='dimgrey')
